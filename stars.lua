...
local blackListedWords = T{string.char(0x81,0x99),string.char(0x81,0x9A),'1%-99','Job Point.*2100','Job Point.*500','JP.*2100','JP.*500','Capacity Point.*2100','Capacity Point.*500','CP.*2100','CP.*500','★','★,', 'Save "Hot2019"', 'Buy?', 'AFK Leech'} -- First two are '☆' and '★' symbols.
